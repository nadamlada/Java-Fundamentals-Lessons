...
public class EX01BlackFlag {
    public static void main(String[] args) {
        ...
        double daily = Integer.parseInt(scanner.nextLine());
        double allExpected = Double.parseDouble(scanner.nextLine());
        double sum = 0.00;
        ...
        // на нула не се дели, да се дефинира
        double percent = (sum / allExpected) * 100;

        if ((sum < allExpected) && allExpected != 0) {
